...
class TasmoClawDriver : Driver
  ...
  def api_chat()
    ...
    # On stock upstream builds, Berry webclient is reliable for small prompts
    # but can fail with larger tool-selection payloads. Run clear device/file
    # intents locally first, and keep the model path for open-ended requests.
